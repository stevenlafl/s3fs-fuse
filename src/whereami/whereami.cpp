...
auto get_current_exe_path() -> std::string {
    ...
    path[dirname_length] = '\0'; // Terminate the string at the directory path end

    std::string result(path, dirname_length); // Construct the string using only the directory part
